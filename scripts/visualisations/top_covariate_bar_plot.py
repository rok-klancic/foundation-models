...
MODELS_TO_PLOT = ['statistical + time_moe_ridge_regression', 'time_moe + statistical_linear_regression', 
                  'statistical + Time-MoE + statistical_linear_regression', 'hidden_layer + statistical_gradient_boosting',
...
english_to_slovene = {
    ...
    'statistical + Time-MoE + statistical_linear_regression': 'VP: lin. reg. + TMoE', 
    'hidden_layer + statistical_gradient_boosting': 'Zadnji sloj + grad. oj. r.',
    'last_layer_weather_injection_weather_mlp': 'Vnos zunanjih spremenljivk'
}

# Define colors for the models
colors = ['#117733', '#999933', '#DDCC77', '#CC6677', '#882255']
...
plt.title('Primerjava metod za razširitev Time-MoE')
...
# Save the plot
plt.savefig(os.path.join(SAVE_FIGURES_PATH, 'top_covariate_bar_plot.pdf'), bbox_inches='tight')
plt.show()