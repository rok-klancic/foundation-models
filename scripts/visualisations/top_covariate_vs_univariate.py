...
MODELS_TO_PLOT = ['statistical + time_moe_ridge_regression', 'ridge_regression_univariate', 'patch-tst', 'time_moe']

english_to_slovene = {
    'statistical + time_moe_ridge_regression': 'ZP: lin. reg. (L2) + TMoE', 
    'ridge_regression_univariate': 'Univariatna linearna  regresija (L2)',
    'patch-tst': 'Patch-TST',
    'time_moe': 'Time-MoE'
}

# Define colors for the models
colors = ['#CC6677', '#332288', '#44AA99', '#117733']
...
plt.title('Primerjava metod za razširitev Time-MoE in univariatnih modelov')
...
# Save the plot
plt.savefig(os.path.join(SAVE_FIGURES_PATH, 'top_covariate_vs_univariate_bar_plot.pdf'), bbox_inches='tight')
plt.show()